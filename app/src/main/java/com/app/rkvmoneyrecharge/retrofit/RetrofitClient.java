...
public class RetrofitClient extends BaseActivity {
    public static Retrofit retrofit;
    //public static final String BASE_URL = "https://paytmbuzz.in/";
    public static final String BASE_URL = "https://egpay.co/";
